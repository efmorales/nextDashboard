...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
    ...
    try {
        ...
        return ({
            title: 'Pokemon page',
            description: 'Lorem ipsum dolor sit amet consectetur adipisicing elit. Amet sed molestias iste eveniet adipisci? Facilis maiores quo, adipisci modi quibusdam doloremque est. Ut, fugit reiciendis? Sequi, perferendis. Numquam, dignissimos voluptatum.'
        })
    }
